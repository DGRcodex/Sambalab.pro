      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-8 md:pb-12" data-aos="fade-up">
            <h2 className="h1 mb-6 text-gray-900 font-playfair text-2xl sm:text-3xl lg:text-4xl font-normal">
              {t.features.title}
            </h2>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-10 items-start" data-aos-id-blocks>
            ...
            >
              <div className="w-full h-40 relative mb-6 overflow-hidden rounded-xl bg-gray-50">
              ...
              <h4 className="h4 mb-3 font-playfair font-bold text-gray-900 text-lg">{t.features.item1Title}</h4>
            ...
            >
              ...
              <h4 className="h4 mb-3 font-playfair font-bold text-gray-900 text-lg">{t.features.item2Title}</h4>
              <p className="text-base text-gray-600 text-center leading-relaxed">
            ...
            >
              ...
              <h4 className="h4 mb-3 font-playfair font-bold text-gray-900 text-lg">{t.features.item3Title}</h4>
              <p className="text-base text-gray-600 text-center leading-relaxed">
