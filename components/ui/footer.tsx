          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
              ...
              <div className="text-sm">
                ...
                <ul>
                  <li className="mb-1"><Link href="/blog" className="text-gray-500 hover:text-purple-700">{t.footer.links.blog}</Link></li>
                  <li className="mb-1"><Link href="/proyectos" className="text-gray-500 hover:text-purple-700">{t.footer.links.cases}</Link></li>
                  <li className="mb-1"><Link href="/herramientas" className="text-gray-500 hover:text-purple-700">{t.footer.links.tools}</Link></li>
                </ul>
              </div>
